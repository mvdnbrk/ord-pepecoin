...
Other inscription ecosystems (Bitcoin ordinals, Doginals) face the same limitations in their scriptSig-based forks. PRC-721 solves this cleanly without breaking existing inscriptions or indexers.
...
The following tag keys are reserved for future use:

| Tag | Purpose |
|-----|---------|
| `"collection"` | Collection name/identifier |

New tags can be added without a protocol upgrade — old parsers and old PRC-721 parsers will simply ignore unknown tags.
